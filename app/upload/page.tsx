  ...
  const startUpload = async () => {
    ...
    const uploadPromises = files.map(async (file) => {
      ...
      try {
        ...
        // Simulate vector database indexing delay
        ...
        <div className="lg:col-span-2 space-y-6">
          {!session && (
            <div className="rounded-xl border border-yellow-500/20 bg-yellow-500/5 p-4 text-sm text-yellow-200/90 flex items-start gap-3 backdrop-blur-sm">
              <svg
                className="w-5 h-5 flex-shrink-0 mt-0.5 text-yellow-400 animate-pulse"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
              ...
              <div>
                ...
                Staged files will simulate chunking, embedding, and
                vectorization, but will not be persisted to the Neon Postgres
                database.{" "}
                <Link
                  href="/auth/signin"
                  className="underline text-yellow-400 font-medium hover:text-yellow-300"
                >
                  Sign in now
                </Link>{" "}
                to save documents.
          ...
          <div>
            ...
            <p className="text-sm text-zinc-400 mt-1">
              Upload documents to expand your AI Knowledge Base. Staged files
              will be processed, chunked, and embedded into the vector index.
            </p>
          </div>
          ...
          >
            ...
            {/* Animated cloud icon */}
            <div
              className={`h-14 w-14 rounded-full bg-zinc-900/80 border border-white/5 flex items-center justify-center text-zinc-400 mb-4 group-hover:scale-110 group-hover:text-violet-400 transition-all duration-300 ${dragActive ? "scale-110 text-violet-400 border-violet-500/20" : ""}`}
            >
              <svg
                className="w-7 h-7"
                fill="none"
            ...
            <p className="text-xs text-zinc-500 mt-1 max-w-xs">
              ...
              or <strong className="text-zinc-300">JSON</strong> (up to 50MB per
              file).
            </p>
        ...
        <div className="space-y-6">
          <div className="border border-white/5 rounded-2xl bg-zinc-900/20 p-6 space-y-6 backdrop-blur-sm">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center text-xs">
                <label className="font-semibold text-zinc-400 uppercase tracking-wider">
                  Chunk Size
                </label>
              ...
              <p className="text-[10px] text-zinc-500 leading-normal">
                Determines the max length of database text blocks parsed. Larger
                chunks capture more context but can introduce noise.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              />
              <p className="text-[10px] text-zinc-500 leading-normal">
                Defines shared token spacing between sequential text blocks.
                Prevents loss of context at chunk margins.
              </p>
            </div>
          </div>
          ...
          <div className="border border-white/5 rounded-2xl bg-zinc-900/20 p-6 space-y-4 backdrop-blur-sm">
            ...
            <p className="text-xs text-zinc-500 leading-relaxed">
              Auto-sync and re-index changes continuously from your team's cloud
              repositories.
            </p>
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <span className="text-[9px] uppercase font-mono bg-zinc-900 border border-white/5 px-2 py-0.5 rounded text-zinc-500">
                  Coming Soon
                </span>
              </button>
